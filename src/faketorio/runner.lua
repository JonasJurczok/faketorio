...
function faketorio.parse_arguments()
    ...
    parser:command("build",
            "Create a folder named after the mod under \"target\" and copy all source files there. No further actions are initialized",
            "This command can be used if you just want to check the assembled mod without actually doing anything with it. \n"..
